...
const kGreenPrimary = Color(0xff81dd73); // Color of logo
const kGreenPrimary_analogous1 = Color(0xff73DD9A);
const kGreenPrimary_analogous2 = Color(0xff7B6DD73);
const kGreenPrimary_shade1 = Color(0xff74C667);
const kGreenPrimary_shade2 = Color(0xff67B05C);

       ...
       body: Container(
         ...
         child: ListView(
           children: [
             ...
             Image.asset("asset/a/paperhatimages/paperhat1.png"),
             Text(" \nNow, take your piece of paper and fold it in half.\n "),
             Image.asset("asset/a/paperhatimages/paperhat2.png"),
             Text(
                 " \nNext, fold the corners into the middle until they touch.\n "),
             Image.asset("asset/a/paperhatimages/paperhat3.png"),
             Text(" \nThen, fold one of the bottom flaps up.\n "),
             Image.asset("asset/a/paperhatimages/paperhat4.png"),
             Text(
                 " \nAnd lastly, turn it and fold the other flap up the other direction.\n "),
             Image.asset("asset/a/paperhatimages/paperhat5.png"),
             Text(" \nNow you are done with your paper hat!\n "),
             Image.asset("asset/a/paperhatimages/paperhatdone.png"),
           ],
         ),
       ));
 }

    ...
    return searchSnapshot != null
        ? ListView.builder(
            ...
            itemBuilder: (context, index) {
              return SearchTile(
                lessonName: searchSnapshot.documents[index].data["title"],
                lessonAuthor: searchSnapshot.documents[index].data["ownerName"],
                image: searchSnapshot.documents[index].data["imageUrl"],
              );
            },
          )
        : Center(

...
class TenMostUsedWords extends StatefulWidget {
  @override
  _TenMostUsedWordsState createState() => _TenMostUsedWordsState();
}

class _TenMostUsedWordsState extends State<TenMostUsedWords> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Ten Most Used Words"),
      ),
      body: Container(
        color: Colors.white,

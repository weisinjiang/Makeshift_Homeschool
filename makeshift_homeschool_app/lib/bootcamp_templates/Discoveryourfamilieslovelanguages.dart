...
class DiscoverYourFamiliesLoveLanguages extends StatefulWidget {
  @override
  _DiscoverYourFamiliesLoveLanguagesState createState() =>
      _DiscoverYourFamiliesLoveLanguagesState();
}

class _DiscoverYourFamiliesLoveLanguagesState
    extends State<DiscoverYourFamiliesLoveLanguages> {
            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  ...
                  Text("You like it when people compliment you with words",
                      style:
                          TextStyle(fontSize: 14, color: Colors.purple[200])),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  Text("You like it when people give you gifts",
              ...
              Row(
                children: [
                  ...
                  Text("You like it when people do helpful things",
              ...
              Row(
                children: [
                  ...
                  Text("You love spending quality time with people",
              ...
              Row(
                children: [
                  ...
                  Text("You like hugs and kisses from friends and family",
                      style:
                          TextStyle(fontSize: 14, color: Colors.orange[200])),
                ],
              ),
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      hintText:
                          "What is it? Will you treat them a bit differently?"),
                ),
              ),
              ...
              RaisedButton(
                  ...
                  onPressed: () async {
                    await save(database, user,
                        "Discover Your Families Love Languages", context);
                  })
            ],
          ),
        ),
